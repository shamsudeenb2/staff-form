// // app/api/personal-data/route.ts
...
// //     const draft = await prisma.personalDataDraft.findFirst({ where: { phone } });
// //     return NextResponse.json({ success: true, data: draft?.data ?? null });
// //   } catch (err) {
// //     console.error(err);
...
//     // upsert draft
//     const draft = await prisma.personalDataDraft.upsert({
//       where: { phone },
//       create: { phone, data },
//       update: { data },
//     });
